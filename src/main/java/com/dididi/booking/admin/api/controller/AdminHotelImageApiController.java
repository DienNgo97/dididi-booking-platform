...
public class AdminHotelImageApiController {
    ...
    public AdminHotelImageApiController(HotelImageService hotelImageService) {
    ...
    public ApiResponse<Void> delete(@PathVariable Long hotelId, @PathVariable Long imageId) {
